...
float[] sine_constant = new float[NUM_POINTS];
//float[] digital_signal = new float[NUM_POINTS];
float[] message_signal = new float[NUM_POINTS];
//float[] modulated_signal = new float[NUM_POINTS];
float[] am_signal = new float[NUM_POINTS];
float[] fm_signal = new float[NUM_POINTS];
